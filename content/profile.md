...
<div>
  ...
  <p class="profile-research"><span class="label-strong">Research:</span> Agent RL & Harness · Reward Modeling</p>
  <div class="hobby-block">
    <p class="hobby-text"><span class="label-strong">Hobbies:</span> Singing · Workout · Competitive Gaming</p>
  </div>
  <div class="quick-links">
    <a class="quick-link" href="https://scholar.google.com/citations?user=20r-yPwAAAAJ&hl=en" target="_blank" rel="noopener noreferrer">
    ...
    <a class="quick-link" href="https://openreview.net/profile?id=~Peng_Lai3" target="_blank" rel="noopener noreferrer">
    ...
    <a class="quick-link" href="mailto:12631205@mail.sustech.edu.cn">
    ...
    <a class="quick-link" href="https://github.com/Laip11" target="_blank" rel="noopener noreferrer">
